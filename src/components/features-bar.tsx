  ...
  return (
    <div className="-mt-20 relative z-10 pb-20">
      <div className="container px-16">
        <div className="bg-[#eaeaec] rounded-2xl p-[30px]">
          <Card className="overflow-hidden rounded-2xl shadow-none">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 md:flex-1">
                <div className="p-6 flex flex-col items-center justify-center text-center gap-3 bg-[#eaeaec]">
                  <Send className="w-10 h-10 text-primary" />
                  <h3 className="font-semibold text-sm mt-2">Eliminación de papel y traslados</h3>
                </div>
                <div className="p-6 flex flex-col items-center justify-center text-center gap-3 border-t sm:border-t-0 sm:border-l bg-[#eaeaec]">
