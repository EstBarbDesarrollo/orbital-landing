          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 md:flex-1">
              <div className="p-2 flex flex-col items-center justify-center text-center gap-1 bg-[#eaeaec]">
                ...
                <h3 className="font-semibold text-[14px] mt-0.5">Eliminación de papel y traslados</h3>
              </div>
              <div className="p-2 flex flex-col items-center justify-center text-center gap-1 border-t sm:border-t-0 sm:border-l bg-[#eaeaec]">
                ...
                <h3 className="font-semibold text-[14px] mt-0.5">Información siempre disponible y protegida</h3>
              </div>
              <div className="p-2 flex flex-col items-center justify-center text-center gap-1 border-t sm:border-t-0 sm:border-l bg-[#eaeaec]">
                <FileText className="w-5 h-5 text-primary" />
                <h3 className="font-semibold text-[14px] mt-0.5">Centralización de documentos y legajos</h3>
              </div>
            </div>
          </div>
        </Card>
