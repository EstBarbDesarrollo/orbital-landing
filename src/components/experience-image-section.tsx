    ...
    <section className="mt-14 relative">
      {image && (
        <>
          ...
          <Link
            href="#"
            className="absolute top-[68%] left-[37%] w-[16%] h-[10%] z-10 border-2 border-black -translate-x-[60px] translate-y-[20px]"
            aria-label="Solicitar atención personalizada"
          />
          {/* Invisible link for "Ingresar a Orbital" */}
          <Link
            href="#"
            className="absolute top-[68%] left-[55%] w-[11%] h-[10%] z-10 border-2 border-black -translate-x-[60px] translate-y-[20px]"
