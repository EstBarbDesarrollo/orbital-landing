...
export function DigitalizeSection() {
  ...
  return (
    <section id="digitalize" className="scroll-mt-20">
      {/* Contenedor principal: Aquí podés cambiar el ancho (w-full) o posición (mx-auto) */}
      <div className="relative w-full max-w-[1920px] mx-auto">
        ...
        {/* Ítems interactivos alineados al margen derecho */}
        
        {/* 1. Firma - Único con dimensiones relativas internas solicitadas */}
        <div 
