  ...
  return (
    <section id="digitalize" className="scroll-mt-20">
      <div className="relative w-full max-w-[1920px] mx-auto">
        ...
        {computerImage && (
          <div className="absolute top-[32%] left-[6.3%] w-[42%]">
              <div className="relative">
                  <Image
                      src={`${computerImage.imageUrl}${computerImage.imageUrl.includes('?') ? '&' : '?'}v=2`}
                  ...
                  <div className="absolute top-[5.2%] left-[9.6%] w-[80.8%] h-[60.6%] z-20 overflow-hidden bg-black rounded-[0.5%] shadow-inner">
                      {activeImage && (
                        <Image
                          src={`${activeImage.imageUrl}${activeImage.imageUrl.includes('?') ? '&' : '?'}v=2`}
        ...
        {/* Ítems alineados a la izquierda (58.7% del contenedor principal) */}
        <div 
